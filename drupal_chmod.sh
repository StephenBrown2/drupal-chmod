...
Note: \"$group\" (apache default) is assumed as the group the server is belonging to,\n
 if this is different you need to modify it manually by editing this script.\n\n
